...
import dev.ceccon.webframework.annotations.WebframeworkPutMethod;
    ...
    private static void extractMethods(String className) throws Exception {
        ...
        for (Method method : Class.forName(className).getDeclaredMethods()) {
            ...
            for (Annotation annotation : method.getAnnotations()) {
                ...
                } else if (annotation.annotationType().getName().equals("dev.ceccon.webframework.annotations.WebframeworkPutMethod")) {
                    httpMethod = "PUT";
